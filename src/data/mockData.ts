...
export const quizSets: QuizSet[] = [
  ...
  {
    id: 'q2',
    title: 'Quiz: Chapter 2 - International AML/CFT Standards',
    questions: [
      { id: 'q2-1', question: 'Which organization is the primary global standard-setter for AML/CFT?', options: ['The World Bank', 'The Financial Action Task Force (FATF)', 'The United Nations', 'The Wolfsberg Group'], correctAnswer: 1, explanation: 'FATF is an inter-governmental body that sets the global standards (The 40 Recommendations) for AML/CFT.', category: 'Global Standards', difficulty: 'easy' },
      { id: 'q2-2', question: 'What are the two main components of a FATF Mutual Evaluation?', options: ['Technical Compliance and Effectiveness', 'Profitability and Liquidity', 'Internal and External Audit', 'Onboarding and Monitoring'], correctAnswer: 0, explanation: 'Mutual evaluations assess whether the necessary laws are in place (Technical Compliance) and whether they are actually working (Effectiveness).', category: 'FATF', difficulty: 'medium' },
      { id: 'q2-3', question: 'Which FATF Recommendation specifically addresses the "Risk-Based Approach"?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 15', 'Recommendation 20'], correctAnswer: 0, explanation: 'Recommendation 1 requires countries to identify, assess, and understand their risks and apply resources accordingly.', category: 'FATF', difficulty: 'easy' },
      { id: 'q2-4', question: 'What is the primary role of the Egmont Group?', options: ['To set global tax standards', 'To provide a platform for Financial Intelligence Units (FIUs) to exchange information', 'To regulate the insurance industry', 'To manage the UN sanctions list'], correctAnswer: 1, explanation: 'The Egmont Group is a global network of FIUs that facilitates the exchange of information and cooperation.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-5', question: 'Which body is responsible for issuing international sanctions that are binding on all UN member states?', options: ['The FATF', 'The United Nations Security Council (UNSC)', 'The Basel Committee', 'The Wolfsberg Group'], correctAnswer: 1, explanation: 'UNSC Resolutions (e.g., 1267 and 1373) are binding on all member states.', category: 'Sanctions', difficulty: 'easy' },
      { id: 'q2-6', question: 'What is the "Wolfsberg Group" primarily known for?', options: ['A group of environmental activists', 'An association of global banks that develops industry standards for AML/KYC', 'A regulatory body in Germany', 'A law enforcement agency'], correctAnswer: 1, explanation: 'Wolfsberg is an industry-led group that publishes influential principles for correspondent and private banking.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-7', question: 'According to the Basel Committee, what are the "Three Lines of Defense" in a bank?', options: ['Front Office, Compliance, and Audit', 'Sales, Marketing, and Finance', 'IT, HR, and Operations', 'Regulator, Board, and CEO'], correctAnswer: 0, explanation: 'The three lines are: 1. Business Units (Front Office), 2. Compliance/Risk Management, and 3. Internal Audit.', category: 'Basel Committee', difficulty: 'medium' },
      { id: 'q2-8', question: 'Which FATF Recommendation covers "Customer Due Diligence" (CDD)?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 15', 'Recommendation 20'], correctAnswer: 1, explanation: 'Recommendation 10 sets the global standard for identifying and verifying customers.', category: 'FATF', difficulty: 'easy' },
      { id: 'q2-9', question: 'What does it mean for a country to be on the FATF "Grey List"?', options: ['The country is subject to a call for counter-measures', 'The country is under increased monitoring and has committed to resolving strategic deficiencies', 'The country is banned from the global financial system', 'The country has achieved full technical compliance'], correctAnswer: 1, explanation: 'The Grey List (Jurisdictions under Increased Monitoring) includes countries working with FATF to address weaknesses.', category: 'FATF', difficulty: 'medium' },
      { id: 'q2-10', question: 'Which UN Convention first defined money laundering as a global offense?', options: ['The Vienna Convention (1988)', 'The Palermo Convention (2000)', 'The Madrid Convention', 'The Geneva Convention'], correctAnswer: 0, explanation: 'The Vienna Convention was the first to criminalize ML, specifically in the context of drug trafficking.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-11', question: 'What is the primary focus of the "Palermo Convention" (2000)?', options: ['Climate change', 'Transnational Organized Crime', 'Cybersecurity', 'Tax evasion'], correctAnswer: 1, explanation: 'The Palermo Convention expanded the definition of money laundering to include all serious crimes.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-12', question: 'Which FATF Recommendation addresses "New Technologies" and the "Travel Rule" for crypto?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 15', 'Recommendation 20'], correctAnswer: 2, explanation: 'Recommendation 15 covers new technologies, including Virtual Asset Service Providers (VASPs).', category: 'FATF', difficulty: 'hard' },
      { id: 'q2-13', question: 'What is the "Corruption Perceptions Index" (CPI)?', options: ['A list of corrupt politicians', 'A ranking of perceived public sector corruption by Transparency International', 'A sanctions list', 'A measure of bank fraud'], correctAnswer: 1, explanation: 'The CPI is a widely used tool for assessing geographic risk related to corruption.', category: 'Global Standards', difficulty: 'easy' },
      { id: 'q2-14', question: 'Which organization facilitates the "Mutual Evaluation" process for its members?', options: ['The World Bank', 'FATF and FATF-Style Regional Bodies (FSRBs)', 'The IMF', 'The Egmont Group'], correctAnswer: 1, explanation: 'FSRBs (like MONEYVAL or APG) conduct evaluations similar to FATF for their regions.', category: 'FATF', difficulty: 'medium' },
      { id: 'q2-15', question: 'What is the primary goal of the "Basel AML Index"?', options: ['To rank the world\'s largest banks', 'To assess a country\'s vulnerability to money laundering and terrorist financing', 'To measure global inflation', 'To track crypto prices'], correctAnswer: 1, explanation: 'The Basel AML Index is an independent ranking that assesses country-level risk.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-16', question: 'Which FATF Recommendation requires the reporting of suspicious transactions (STRs)?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 20', 'Recommendation 40'], correctAnswer: 2, explanation: 'Recommendation 20 is the global standard for reporting suspicion to the FIU.', category: 'FATF', difficulty: 'easy' },
      { id: 'q2-17', question: 'What is the role of the "Wolfsberg Anti-Money Laundering Principles for Correspondent Banking"?', options: ['To set interest rates', 'To provide industry-led guidance on due diligence for respondent banks', 'To regulate trade finance', 'To issue banking licenses'], correctAnswer: 1, explanation: 'Wolfsberg principles are the industry gold standard for managing correspondent banking risks.', category: 'Global Standards', difficulty: 'hard' },
      { id: 'q2-18', question: 'Which body is the global standard-setter for securities regulation?', options: ['The Basel Committee', 'IOSCO', 'The FATF', 'The Wolfsberg Group'], correctAnswer: 1, explanation: 'IOSCO (International Organization of Securities Commissions) sets the standards for the securities sector.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-19', question: 'What is the "Financial Secrecy Index"?', options: ['A list of secret bank accounts', 'A ranking of jurisdictions based on their secrecy and scale of activities by Tax Justice Network', 'A sanctions list', 'A measure of corporate transparency'], correctAnswer: 1, explanation: 'The index highlights jurisdictions that facilitate tax abuse and financial secrecy.', category: 'Global Standards', difficulty: 'medium' },
      { id: 'q2-20', question: 'How many "Immediate Outcomes" (IOs) does FATF use to measure effectiveness?', options: ['5', '11', '40', '21'], correctAnswer: 1, explanation: 'FATF uses 11 IOs to assess how well a country\'s AML/CFT system actually works.', category: 'FATF', difficulty: 'hard' }
    ]
  },
  {
    id: 'q3',
  ...
  {
    id: 'q6',
    title: 'Quiz: Chapter 6 - Guidance & Cooperation',
    questions: [
      { id: 'q6-1', question: 'What is the primary purpose of a National Risk Assessment (NRA)?', options: ['To identify risks within a single bank', 'To evaluate a jurisdiction-wide ML/TF threats and vulnerabilities', 'To rank banks by profitability', 'To monitor individual transactions'], correctAnswer: 1, explanation: 'An NRA is a country-level evaluation of risks, as required by FATF Recommendation 1.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-2', question: 'Which body is responsible for receiving, analyzing, and disseminating financial intelligence?', options: ['The Central Bank', 'The Financial Intelligence Unit (FIU)', 'The Police', 'The Tax Authority'], correctAnswer: 1, explanation: 'The FIU is the central agency for financial intelligence (FATF Recommendation 29).', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-3', question: 'What is "Mutual Legal Assistance" (MLA)?', options: ['Banks sharing customer data', 'The formal process of countries cooperating in legal matters and evidence sharing', 'A type of insurance', 'A voluntary agreement between FIs'], correctAnswer: 1, explanation: 'MLA is the legal basis for international cooperation in criminal matters.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-4', question: 'Which of the following is a "Public-Private Partnership" (PPP)?', options: ['A bank merger', 'A vehicle for sharing information between authorities and the private sector', 'A government-owned bank', 'A private security firm'], correctAnswer: 1, explanation: 'PPPs (like the JMLIT in the UK) facilitate information sharing to fight financial crime.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-5', question: 'What is the "J5 Partnership"?', options: ['A group of 5 global banks', 'A collaboration between tax authorities of AU, CA, NL, UK, and US', 'A UN committee', 'A regional FATF body'], correctAnswer: 1, explanation: 'The J5 focuses on tax crime and money laundering.', category: 'Cooperation', difficulty: 'hard' },
      { id: 'q6-6', question: 'What is "Strategic Intelligence" provided by an FIU?', options: ['Information about a specific suspect', 'Broad views of financial crime types, trends, and patterns', 'A bank\'s marketing strategy', 'A list of new regulations'], correctAnswer: 1, explanation: 'Strategic intelligence looks at the "big picture" of crime trends.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-7', question: 'Which organization publishes the "Corruption Perceptions Index" (CPI)?', options: ['FATF', 'Transparency International', 'The World Bank', 'The IMF'], correctAnswer: 1, explanation: 'Transparency International is a leading NGO focused on corruption.', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-8', question: 'What is "COSMIC" in the context of Singapore?', options: ['A space program', 'A digital platform for FIs to share information on red-flagged customers', 'A new type of crypto-asset', 'A regulatory body'], correctAnswer: 1, explanation: 'COSMIC facilitates information sharing among banks in Singapore.', category: 'Cooperation', difficulty: 'hard' },
      { id: 'q6-9', question: 'What is the primary role of a "Regulator" in the AFC context?', options: ['To arrest criminals', 'To set rules, authorize businesses, and conduct risk-based supervision', 'To file SARs', 'To manage the FIU'], correctAnswer: 1, explanation: 'Regulators oversee the compliance of covered entities.', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-10', question: 'Which of the following is a "Thematic" risk assessment?', options: ['A review of all banks', 'An evaluation of a specific issue like emerging technologies (e.g., DeFi)', 'A national census', 'A credit risk review'], correctAnswer: 1, explanation: 'Thematic assessments focus on specific, often emerging, risks.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-11', question: 'What is the "Egmont Group"?', options: ['A group of global banks', 'An international network of national FIUs', 'A sanctions body', 'A regional FATF body'], correctAnswer: 1, explanation: 'Egmont facilitates information exchange between FIUs.', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-12', question: 'What is "Operational Analysis" by an FIU?', options: ['Analyzing the FIU\'s budget', 'Analyzing specific transactions or entities to identify potential crimes', 'Analyzing global trends', 'Analyzing employee performance'], correctAnswer: 1, explanation: 'Operational analysis focuses on specific cases and suspects.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-13', question: 'Which FATF Recommendation requires countries to have an FIU?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 29', 'Recommendation 40'], correctAnswer: 2, explanation: 'Recommendation 29 mandates the establishment of an FIU.', category: 'Cooperation', difficulty: 'hard' },
      { id: 'q6-14', question: 'What is "Safe Harbor" in the context of information sharing?', options: ['A place to hide money', 'Legal protection for FIs when sharing information in good faith', 'A type of offshore account', 'A regulatory exemption'], correctAnswer: 1, explanation: 'Safe harbor protections encourage FIs to share information without fear of legal reprisal.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-15', question: 'Which of the following is a "Strategic" partner for an FIU?', options: ['A local grocery store', 'Law Enforcement Agencies (LEA)', 'A travel agency', 'A sports club'], correctAnswer: 1, explanation: 'LEAs are primary consumers of FIU intelligence.', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-16', question: 'What is "Mutual Evaluation"?', options: ['A bank\'s performance review', 'A peer review process to assess a country\'s compliance with FATF standards', 'A customer\'s credit check', 'A type of internal audit'], correctAnswer: 1, explanation: 'Mutual evaluations are the core of FATF\'s monitoring mechanism.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-17', question: 'What is "Technical Compliance" in a FATF evaluation?', options: ['Whether the system is fast', 'The extent to which a country has implemented the 40 Recommendations in its laws', 'The number of SARs filed', 'The size of the compliance budget'], correctAnswer: 1, explanation: 'Technical compliance looks at the legal and regulatory framework.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-18', question: 'What is "Effectiveness" in a FATF evaluation?', options: ['How much money the bank makes', 'The extent to which the AML/CFT framework achieves the 11 Immediate Outcomes', 'The number of employees in compliance', 'The speed of transaction monitoring'], correctAnswer: 1, explanation: 'Effectiveness assesses the real-world impact of the AML system.', category: 'Cooperation', difficulty: 'medium' },
      { id: 'q6-19', question: 'Which body is the global standard-setter for securities regulation?', options: ['Basel Committee', 'IOSCO', 'FATF', 'Wolfsberg Group'], correctAnswer: 1, explanation: 'IOSCO sets standards for the securities sector.', category: 'Cooperation', difficulty: 'easy' },
      { id: 'q6-20', question: 'What is the "Wolfsberg Group"?', options: ['A group of regulators', 'An association of global banks that develops industry standards', 'A law enforcement agency', 'A UN committee'], correctAnswer: 1, explanation: 'Wolfsberg is an influential industry-led body.', category: 'Cooperation', difficulty: 'easy' }
    ]
  },
  {
    id: 'q7',
    title: 'Quiz: Chapter 7 - Final Review & Strategy',
    questions: [
      { id: 'q7-1', question: 'What is the approximate weightage of "Risks and Methods" in the CAMS exam?', options: ['10%', '20%', '30%', '40%'], correctAnswer: 1, explanation: 'Risks and Methods typically account for about 20% of the exam.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-2', question: 'Which of the following is a "Core Pillar" of an AML program?', options: ['Marketing', 'Independent Audit', 'Sales', 'IT Support'], correctAnswer: 1, explanation: 'Independent Audit is one of the five core pillars.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-3', question: 'What is the primary goal of the "Risk-Based Approach"?', options: ['To eliminate all risk', 'To allocate resources where the risks are highest', 'To treat all customers equally', 'To reduce compliance costs'], correctAnswer: 1, explanation: 'RBA is about efficient and effective risk management.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-4', question: 'In the "Linguistix" case study, what was the primary indicator of a front company?', options: ['Low transaction volume', 'Revenue significantly exceeding initial KYC projections with high-risk origins', 'The company had a physical office', 'The directors were local'], correctAnswer: 1, explanation: 'Deviations from expected business profiles are key red flags.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-5', question: 'What is the "Travel Rule" for crypto-assets?', options: ['A rule for declaring crypto at customs', 'A requirement for VASPs to share originator and beneficiary info', 'A ban on using crypto while traveling', 'A tax on crypto transfers'], correctAnswer: 1, explanation: 'FATF Recommendation 15 requires data transmission with crypto transfers.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-6', question: 'Which organization is the global network for FIUs?', options: ['FATF', 'The Egmont Group', 'The World Bank', 'The IMF'], correctAnswer: 1, explanation: 'Egmont facilitates FIU cooperation.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-7', question: 'What is "Willful Blindness"?', options: ['A medical condition', 'Deliberately ignoring suspicious activity to avoid liability', 'A type of internal audit', 'A regulatory requirement'], correctAnswer: 1, explanation: 'Willful blindness is legally equivalent to knowledge.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-8', question: 'What is the standard threshold for UBO identification?', options: ['10%', '25%', '50%', '100%'], correctAnswer: 1, explanation: '25% is the widely accepted standard threshold.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-9', question: 'Which line of defense is responsible for independent testing?', options: ['1st Line', '2nd Line', '3rd Line (Internal Audit)', 'The Board'], correctAnswer: 2, explanation: 'Internal Audit provides independent assurance.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-10', question: 'What is the primary risk of "Nesting"?', options: ['It is too slow', 'It obscures the ultimate customer in correspondent banking', 'It is only for small banks', 'It is a type of tax evasion'], correctAnswer: 1, explanation: 'Nesting hides the identity of the banks and customers involved.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-11', question: 'Which FATF Recommendation covers CDD?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 20', 'Recommendation 40'], correctAnswer: 1, explanation: 'Recommendation 10 is the standard for CDD.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-12', question: 'What is "De-risking"?', options: ['Reducing risk', 'Terminating entire client categories to avoid risk', 'A type of insurance', 'A regulatory requirement'], correctAnswer: 1, explanation: 'De-risking is a broad exclusion of sectors.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-13', question: 'What is the "Fraud Triangle"?', options: ['A type of crime', 'A model explaining factors leading to fraud: Pressure, Opportunity, Rationalization', 'A regulatory body', 'A sanctions list'], correctAnswer: 1, explanation: 'The triangle helps understand why fraud occurs.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-14', question: 'What is "Structuring"?', options: ['Building a bank', 'Breaking down cash deposits to avoid thresholds', 'A type of corporate merger', 'A regulatory report'], correctAnswer: 1, explanation: 'Structuring is a common placement technique.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-15', question: 'Which body issues binding UN sanctions?', options: ['FATF', 'UN Security Council (UNSC)', 'The World Bank', 'The IMF'], correctAnswer: 1, explanation: 'UNSC resolutions are binding on all member states.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-16', question: 'What is "Source of Wealth" (SOW)?', options: ['Money for a transaction', 'The origin of a customer\'s entire net worth', 'A bank account number', 'A salary slip'], correctAnswer: 1, explanation: 'SOW looks at the total accumulation of wealth.', category: 'Review', difficulty: 'medium' },
      { id: 'q7-17', question: 'What is "Tipping Off"?', options: ['Giving a waiter a tip', 'Informing a customer they are under investigation', 'A type of transaction monitoring', 'A regulatory fine'], correctAnswer: 1, explanation: 'Tipping off is a serious offense.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-18', question: 'What is the "Egmont Group"?', options: ['A group of banks', 'An international network of FIUs', 'A sanctions body', 'A regional FATF body'], correctAnswer: 1, explanation: 'Egmont facilitates information exchange.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-19', question: 'What is "Residual Risk"?', options: ['Risk before controls', 'Risk remaining after controls are applied', 'Risk that cannot be measured', 'Risk of a system failure'], correctAnswer: 1, explanation: 'Residual risk is the final risk exposure.', category: 'Review', difficulty: 'easy' },
      { id: 'q7-20', question: 'Which FATF Recommendation requires STR reporting?', options: ['Recommendation 1', 'Recommendation 10', 'Recommendation 20', 'Recommendation 40'], correctAnswer: 2, explanation: 'Recommendation 20 is the standard for reporting suspicion.', category: 'Review', difficulty: 'easy' }
    ]
  },
  {
    id: 'q8',
...
quizSets.forEach(set => {
  ...
  const practiceQuestions: Partial<QuizQuestion>[] = [
    ...
    {
      question: "What is the primary risk of 'Nesting' in correspondent banking?",
      options: [
        "It makes transactions faster",
        "It allows a respondent bank to provide services to other banks without the correspondent bank's knowledge",
        "It reduces the cost of wire transfers",
        "It is only used by major global banks"
      ],
      correctAnswer: 1,
      explanation: "Nesting obscures the ultimate customer and the banks involved, creating significant AML risk.",
      category: 'Sector Risks'
    },
    {
      question: "Which line of defense is responsible for independent testing of the AML program?",
      options: ["1st Line", "2nd Line", "3rd Line (Internal Audit)", "The Board"],
      correctAnswer: 2,
      explanation: "Internal Audit (3rd Line) provides independent assurance to senior management.",
      category: 'Compliance'
    },
    {
      question: "What is 'Willful Blindness'?",
      options: [
        "A medical condition",
        "Deliberately ignoring suspicious activity to avoid legal responsibility",
        "A type of internal audit",
        "A regulatory requirement"
      ],
      correctAnswer: 1,
      explanation: "Willful blindness is legally equivalent to actual knowledge of a crime.",
      category: 'Fundamentals'
    },
    {
      question: "What is the standard threshold for identifying an Ultimate Beneficial Owner (UBO)?",
      options: ["10%", "25%", "50%", "100%"],
      correctAnswer: 1,
      explanation: "The standard threshold for UBO identification is 25% ownership or control.",
      category: 'Compliance'
    },
    {
      question: "Which FATF Recommendation requires the reporting of suspicious transactions (STRs)?",
      options: ["Recommendation 1", "Recommendation 10", "Recommendation 20", "Recommendation 40"],
      correctAnswer: 2,
      explanation: "Recommendation 20 mandates that financial institutions report suspicious transactions to the FIU.",
      category: 'Standards'
    }
  ];

  for (let i = count + 1; i <= 20; i++) {
    const pq = practiceQuestions[(i - 1) % practiceQuestions.length];
    set.questions.push({
      id: `${chapterId}-p${i}`,
      ...
      category: pq.category as any || 'Practice',
      difficulty: 'medium'
    });
  }
});
