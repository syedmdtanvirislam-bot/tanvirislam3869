...
const Dashboard: React.FC = () => {
  ...
  const progressData = [
    { name: 'Progress', value: 65, fill: '#3b82f6' }
  ];
  ...
  const stats = [
    { label: 'Course Progress', value: '65%', icon: TrendingUp, color: 'text-blue-600', bg: 'bg-blue-50' },
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tracking-tight">AML</h2>
          <p className="text-slate-600 dark:text-slate-400 mt-2 max-w-2xl">Developed by Tanvir. Track your CAMS exam preparation progress and latest updates.</p>
        </div>
        <div className="bg-blue-600 text-white px-6 py-4 rounded-2xl shadow-xl shadow-blue-500/20 flex items-center gap-4 self-start md:self-center">
          <div className="p-2 bg-white/20 rounded-lg">
            <Clock size={24} />
          </div>
          <div>
            <p className="text-[10px] uppercase font-bold text-blue-100 tracking-widest">Exam Countdown</p>
            <p className="text-lg font-bold">24 Days Remaining</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 lg:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="w-full h-48 mt-8">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center mt-4">
              <p className="text-4xl font-black text-slate-900 dark:text-white">65%</p>
